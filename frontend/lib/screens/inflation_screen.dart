...
class InflationScreenState extends State<InflationScreen> {
  ...
  Future<void> _fetchAndCalculateInflation() async {
    ...
    try {
      await _database.getAllExpenses();
      if (mounted) {
        setState(() {
          _hasPriceBasket = false;
          _personalInflation = null;
          _officialInflation = null;
          _breakdowns = [];
        });
      }
    } finally {
                        ...
                        AspectRatio(
                          ...
                          child: BarChart(
                            BarChartData(
                                ...
                                touchTooltipData: BarTouchTooltipData(
                                  ...
                                  getTooltipItem:
                                      (group, groupIndex, rod, rodIndex) {
                                        final cat =
                                            _breakdowns[groupIndex].category;
                              ...
                              barGroups: List.generate(_breakdowns.length, (
                                index,
                              ) {
