...
Ayrıntılı komut/sonuç özeti: [production kapanış kanıtı](./evidence/production-close-2026-08-01.md).
...
`operations/frontend-release.md` izlenmelidir.
...
- [ ] ZIP'i aç; kökte `README.md`, `LICENSE.md`, `CHANGELOG.md` ve `docs/` klasörünü gör.
